...
from const import (ANOTHER_PIC, SCREEN_WIDTH, SCREEN_HEIGHT, TEXT_POS_X, TEXT_POS_Y,
                   FONT_NAME, FONT_SIZE, TEXT_DEFEAT, BUTTON_POS_X, BUTTON_POS_Y, BUTTON_MESSAGE,
                   RESULT_BUTTON_WIDTH, RESULT_BUTTON_HEIGHT)
from Button import Button
import views.MainView


class DefeatView(View):
    def __init__(self):
        super().__init__()
    ...
    def on_draw(self):
        ...
        draw_lrwh_rectangle_textured(0, 0,
                                     ...
                                     self.background)
        draw_text(TEXT_DEFEAT, TEXT_POS_X, TEXT_POS_Y, color.COOL_BLACK,
